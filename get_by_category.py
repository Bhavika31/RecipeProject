...
def search_recipes_by_ingredients():
    ...
    for recipe in recipes:
        ...
        recipe_details[meal_name]['input_ingredients'].add(recipe[7])
    ...
    for recipe_name, details in recipe_details.items():
        ...
        for ingredient in details['input_ingredients']:
        ...
        remaining_ingredients = cursor.execute(remaining_query, [details['name'], *details['input_ingredients']]).fetchall()
